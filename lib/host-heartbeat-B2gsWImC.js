...
function defaultDesktopAuthPath() {
	...
	if (process.platform === "win32") return join(home, "AppData", "Roaming", "CodeBuddyExtension", "Data", "Public", "auth", "workbuddy-desktop.info");
...
var WorkBuddyCredentialStore = class {
	...
	*/
	resolveDesktopPath() {
		...
		return this.desktopPathOverride ?? (fromEnv !== void 0 && fromEnv.trim() !== "" ? fromEnv : void 0) ?? defaultDesktopAuthPath();
	}
	/**
	...
	*/
	...
	async readDesktop() {
		...
		if (desktopPath === void 0) return void 0;
		try {
	...
	async desktopFilePresent() {
		const desktopPath = this.resolveDesktopPath();
		if (desktopPath === void 0) return false;
		try {
...
const WORKBUDDY_CONNECT_VERSION = "0.1.0";
//#endregion
...
//#endregion
export { defaultDesktopAuthPath as _, workbuddyHostHeartbeatPath as a, WorkBuddyUpstreamClient as c, regionOf as d, FALLBACK_WORKBUDDY_MODELS as f, WorkBuddyCredentialStore as g, WORKBUDDY_AUTH_FILE_ENV as h, readHostHeartbeat as i, classifyUpstreamError as l, WORKBUDDY_AUTH_FILENAME as m, clearHostHeartbeat as n, writeHostHeartbeat as o, WorkBuddyCatalog as p, isHeartbeatProcessAlive as r, WORKBUDDY_CONNECT_VERSION as s, WORKBUDDY_HOST_HEARTBEAT_FILENAME as t, prepareChatBody as u, parseWorkBuddyAuth as v, workbuddyOwnAuthPath as y };
