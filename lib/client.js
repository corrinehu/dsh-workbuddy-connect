	...
	factory: (require) => {
		...
		*/
		function AccountRow({ account, t, onRemove }) {
			...
			const control = onRemove === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				style: bodyStyle,
				children: account.state === "signed-in" ? account.nickname ?? account.key : t("signedOut")
				...
				onClick: () => {
					...
					if (phase === "confirm") doRemove();
				},
				children: phase === "idle" ? t("removeAccount") : phase === "confirm" ? t("confirmRemoveAccount") : t("removingAccount")
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: quotaGroupStyle,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								"aria-hidden": "true",
								style: dotStyle(account.state)
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: title })]
						}), control]
					}),
					failed === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: errorStyle,
						children: t("removeAccountFailed", { message: failed })
					}),
					account.expiresAt === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: bodyStyle,
						children: t("accessTokenExpires", { time: formatTime(account.expiresAt) })
					}),
					account.credits === void 0 ? null : account.credits.accounts.filter((c) => c.remain > 0).map((c, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CreditBar, {
						label: c.packageName,
						remain: c.remain,
						size: c.size,
						t
					}, `${c.packageName}-${String(index)}`)),
					account.creditsError === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: errorStyle,
						children: t("creditsError", { message: account.creditsError })
					})
				]
			});
		}
		...
		function WorkBuddyPluginCard({ t }) {
			...
			*/
			const removeAccount = (0, react.useCallback)(async (key) => {
				...
				if (!response.ok) {
					const value = await response.json().catch(() => void 0);
					const message = typeof value?.error === "string" ? value.error : `HTTP ${String(response.status)}`;
			...
			const label = status.status === "signed-in" ? accounts === void 0 ? status.nickname === void 0 ? t("signedInAs", { nickname: "" }).replace(/[:：]\s*$/, "") : t("signedInAs", { nickname: status.nickname }) : t("multiAccountCount", { count: accounts.length }) : status.status === "error" ? t("requestFailed") : t("signedOut");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						status.status === "signed-in" && accounts !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [accounts.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("hr", { style: dividerStyle }) : null, accounts.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							style: bodyStyle,
							children: t("multiAccountEmpty")
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								...quotaListStyle,
								gap: 14
							},
							children: accounts.map((account, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [index > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("hr", { style: {
								...dividerStyle,
								margin: 0
							} }) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountRow, {
								account,
								t,
								onRemove: removeAccount
							})] }, account.key))
						})] }) : null,
						status.status === "signed-in" && accounts === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
